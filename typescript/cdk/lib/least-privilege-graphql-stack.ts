...
import { AuthorizationType, CfnApiKey, MappingTemplate, PrimaryKey, Values, GraphqlApi, Schema, FieldLogLevel } from '@aws-cdk/aws-appsync';
...
export class LeastPrivilegeGraphQLServiceStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: graphqlStackProps) {
    ...
    //Update our Admin Role to allow it to invoke a GraphQl Endpoint.
    props?.adminRole.addToPolicy(
      new PolicyStatement({
